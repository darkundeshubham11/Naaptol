...
public class HomeFurnishing {
	...
	@FindBy(linkText = "Home Furnishing")
	...
	public HomeFurnishing(WebDriver driver) {
		this.driver = driver;
	...
	public void clickOnhomeFurnishing() {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		wait.until(ExpectedConditions.visibilityOf(homeFurnishing));
		homeFurnishing.click();
	}

	public void filterAndPurchasehomeFurnishing() {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
