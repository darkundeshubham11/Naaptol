...
//	WebElement PatternCheckbox;
	...
	public void filterAndPurchaseDecor() {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
...
//		}
		...
		// Click on the Decor item
		wait.until(ExpectedConditions.visibilityOf(firstDecorItemLink));
		firstDecorItemLink.click();
